...
public class ObdReaderService extends IntentService implements DefineObdReader {
    ...
    private String mBtDeviceAdress;
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        if(intent != null && intent.getExtras() != null)
            mBtDeviceAdress = intent.getExtras().getString("device_address");
        // setUpAsForeground();
    ...
    private void findObdDevicesAndConnect() {
        ...
        if (!isConnected) {
            try
            {
                BluetoothDevice device = mBluetoothAdapter.getRemoteDevice(mBtDeviceAdress);
                connectOBDDevice(device);
            } catch (Exception e) {
                L.i("connectOBDDevice return Exception :: " + e.getMessage());
            }
                    ...
                    final Thread newThread = new Thread(new Runnable() {
                        ...
                        public void run() {
                            try {
                                ...
                                mIsRunningSuccess = false;
                                L.i("In new thread reset command  exception :: " +  e.getMessage());
                            }
